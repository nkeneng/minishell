...
# define W_SPLITSPACE	16384	/* Split this word on " "*/
# define W_NOSPLIT	32768	/* Do not perform word splitting on this word because ifs is empty string. */
# define W_EXPANDRHS	65536	/* Expanding word in ${paramOPword} */
